...
{/* npm module bug documented on official tracking GitHub repo*/
}
...
class Home extends React.Component {
  ...
  componentDidMount() {
    ...
    window
      .tracking
      .ColorTracker
      .registerColor('blue', function (r, g, b) {
    ...
    this.tracker = new window
      .tracking
      .ColorTracker(['magenta', 'cyan', 'yellow', 'blue']);
  }
    ...
    this
      ...
      .on('track', (event) => {
        ...
        if ((obj.height - obj.width) > 0) {
          this.setState({colorMatched: obj.colorMatchedStatus, size: 'M', width: obj.width, height: obj.height, color: obj.color});
        } else {
          this.setState({colorMatched: obj.colorMatchedStatus, size: 'L', width: obj.width, height: obj.height, color: obj.color});
        }
      });

    window
      .tracking
      .track(img, this.tracker);
  }
        ...
        <div className="row">
          ...
          <div className="col-6" style={styles.divOutline}>
            ...
            <div style={styles.displayInline}>
              {this.state.screenshot
                ? <button
                    style={Object.assign({}, styles.positionRelative, styles.marginTop5)}
                    type="button"
